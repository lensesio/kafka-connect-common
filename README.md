...
[<img src="https://img.shields.io/badge/latest%20release-v0.7.1-blue.svg?label=latest%20release"/>](http://search.maven.org/#search%7Cga%7C1%7Cg%3A%22com.datamountaineer%22%20AND%20a%3A%22kafka-connect-common%22)
...
#sbt
libraryDependencies += "com.datamountaineer" % "kafka-connect-common" % "0.7.1"

#gradle
'com.datamountaineer:kafka-connect-common:0.7.1'
```
