...
object TraitConfigConst {
  ...
  val CONNECTION_HOST_SUFFIX = "connection.host"
  val CONNECTION_HOSTS_SUFFIX = "connections.host"
  val CONNECTION_PORT_SUFFIX = "connection.port"
  val CONNECTION_PORTS_SUFFIX = "connection.port"
